...
def VNS(initial_S, travel_costs, incompatibilities, vns_max_intentos):
    ...
    while check_iterations < 3 and vns_max_intentos > 0:
        ...
        swap_cost, swap_solution, list_iterations_swap, result_iteration_swap = swap_local_search(current_solution, current_cost, travel_costs, incompatibilities, iterations_swap)
        
        three_cost, three_solution, list_iterations_3_opt, result_iteration_3_opt = three_opt(swap_solution, swap_cost, travel_costs, iterations_3_opt)
        corridas += 1
        vns_max_intentos -= 1
